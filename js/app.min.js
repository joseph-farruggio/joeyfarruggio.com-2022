...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  var initVimeoPlayer = () => {
    module_default.data("player", (playerID, iframe = new player_es_default(document.getElementById(playerID))) => ({
      ...
      toggleVideo() {
        ...
        var here = this;
        iframe.on("ended", function(data2) {
          here.playing = false;
        });
      }
    }));
  ...
  document.addEventListener("alpine:init", () => {
    ...
    module_default.data("visibleNavHighlighter", () => ({
      headings: void 0,
      visibleHeadingId: null,
      init() {
        this.headings = document.querySelectorAll("h2:not(.ignore-toc), h3:not(.ignore-toc), h4:not(.ignore-toc)");
    ...
    module_default.store("showToc", false);
  });
  VimeoPlayer_default();
