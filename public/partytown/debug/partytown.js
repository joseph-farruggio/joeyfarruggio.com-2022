    ...
    function ready() {
        if (!isReady) {
            ...
            if (top != win) {
                ...
                useAtomics && (useAtomics = !win.location.search.includes("forceServiceWorker"));
                useAtomics ? loadSandbox(1) : nav.serviceWorker ? nav.serviceWorker.register(libPath + "partytown-sw.js" + (useAtomics ? "?isolated" : ""), {
                    scope: libPath
